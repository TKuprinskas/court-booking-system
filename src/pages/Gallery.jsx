                    ...
                    <SRLWrapper>
                        ...
                        >
                            <Box component="div" sx={{ marginRight: '5px' }}>
                                <img src={one} alt="1" width={240} height={240} style={{ objectFit: 'scale-down' }} />
                            </Box>
                            <Box component="div" sx={{ marginRight: '5px' }}>
                                <img src={two} alt="2" width={240} height={240} style={{ objectFit: 'scale-down' }} />
                            </Box>
                            <Box component="div" sx={{ marginRight: '5px' }}>
                                <img src={three} alt="3" width={240} height={240} style={{ objectFit: 'scale-down' }} />
                            </Box>
                            <Box component="div" sx={{ marginRight: '5px' }}>
                                <img src={four} alt="4" width={240} height={240} style={{ objectFit: 'scale-down' }} />
                            </Box>
                            <Box component="div" sx={{ marginRight: '5px' }}>
                                <img src={five} alt="5" width={240} height={240} style={{ objectFit: 'scale-down' }} />
                            </Box>
                            <Box component="div" sx={{ marginRight: '5px' }}>
                                <img src={six} alt="6" width={240} height={240} style={{ objectFit: 'scale-down' }} />
                            </Box>
                        </Box>
                    </SRLWrapper>
                </Box>
