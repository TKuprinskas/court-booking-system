    ...
    <Container sx={{ mt: 10, mb: 2 }}>
      <div>
        ...
        <h3>
          Interneto svetainė &nbsp;
          <a
            href='https://mtenisas.lt'
            target='_blank'
            rel='noreferrer noopener'>
            mtenisas.lt
          </a>
          &nbsp; (toliau Teniso Partneris) priklauso ir ją tvarko VšĮ „Teniso
          partneris“ (Duomenų valdytojas) ir asmenys sudarę darbo ar kitokio
          pobūdžio sutartis su ja.
        </h3>
        <br />
        <h4>1. ĮŽANGA</h4>
        <p>
          ...
          &nbsp; (toliau Teniso Partneris) svetainėje ar besinaudojantiems jos
          Paslaugomis.
        </p>
        <p>
        ...
        <br />
        <h4>2. Teniso Partneris RENKAMA INFORMACIJA</h4>
        <p>
        ...
        <p>
          ...
          naudoti. Sutikimus dėl tiesioginės rinkodaros gauna tiesiogiai iš
          Lankytojų, jiems aiškiai išreiškus valią (sutikimą) gauti Teniso
          Partneris tiesioginės rinkodaros pasiūlymus, bei iš Lankytojų, duomenų
        ...
        <br />
        <h4>5. INFORMACIJOS APSAUGOS PRIEMONĖS</h4>
        <p>
